...
enum class WebFeature {
    ...
    kHTMLSlotElement,
    kHTMLTableCellElementColspan,
    kHTMLTableCellElementColspanGreaterThan1000,
    kHTMLTableCellElementColspanGreaterThan8190,
    kInnerTextWithShadowTree,
    kLineClamp,
    kLocalCSSFile,
    kLocalCSSFileExtensionRejected,
    kMiddleClickAutoscrollStart,
    kNegativeBackgroundSize,
    kNegativeMaskSize,
    kOpacityWithPreserve3DQuirk,
    ...
    kScrollAnchored,
    kScrollByKeyboardArrowKeys,
    kScrollByKeyboardHomeEndKeys,
    kScrollByKeyboardPageUpDownKeys,
