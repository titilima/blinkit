...
#ifndef BLINKIT_SCRIPT_STREAMER_H
#define BLINKIT_SCRIPT_STREAMER_H
...
public:
    ...
    {
        return GCWrapShared(new ScriptStreamer(resource, scriptType, loadingTaskRunner));
    }
...
#endif // BLINKIT_SCRIPT_STREAMER_H
