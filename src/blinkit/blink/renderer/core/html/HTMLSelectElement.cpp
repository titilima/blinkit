...
#include "blinkit/blink/renderer/core/layout/LayoutMenuList.h"
...
#include "blinkit/blink/renderer/platform/PopupMenu.h"
...
void HTMLSelectElement::setLength(unsigned newLen, ExceptionState& exceptionState)
{
    ...
    if (diff < 0) { // Add dummy elements.
        do {
            GCRefPtr<Element> e = document().createElement(optionTag.localName(), nullptr, false);
