...
#include "blinkit/blink/renderer/core/css/CSSMarkup.h"
...
#include "blinkit/blink/renderer/platform/text/BidiResolver.h"
#include "blinkit/blink/renderer/platform/text/BidiTextRun.h"
#include "blinkit/blink/renderer/platform/text/TextRunIterator.h"
...
GCRefPtr<DocumentFragment> HTMLElement::textToFragment(const String& text, ExceptionState& exceptionState)
{
...
void HTMLElement::setInnerText(const String& text, ExceptionState& exceptionState)
{
    ...
    GCRefPtr<DocumentFragment> fragment = textToFragment(text, exceptionState);
    if (!exceptionState.hadException())
...
void HTMLElement::setOuterText(const String& text, ExceptionState& exceptionState)
{
    ...
    parent->replaceChild(newChild.get(), this, exceptionState);
