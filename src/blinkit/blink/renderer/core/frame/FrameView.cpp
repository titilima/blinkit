...
#include "blinkit/blink/renderer/core/css/FontFaceSet.h"
...
#include "blinkit/blink/renderer/core/editing/RenderedPosition.h"
...
#endif
#include "blinkit/blink/renderer/core/html/HTMLTextFormControlElement.h"
...
#if 0 // BKTODO:
#include "blinkit/blink/renderer/core/layout/LayoutAnalyzer.h"
#include "blinkit/blink/renderer/core/layout/LayoutCounter.h"
#include "blinkit/blink/renderer/core/layout/LayoutEmbeddedObject.h"
#endif
#include "blinkit/blink/renderer/core/layout/LayoutInline.h"
#include "blinkit/blink/renderer/core/layout/LayoutListBox.h"
#include "blinkit/blink/renderer/core/layout/LayoutPart.h"
#include "blinkit/blink/renderer/core/layout/LayoutScrollbar.h"
#include "blinkit/blink/renderer/core/layout/LayoutScrollbarPart.h"
...
// BKTODO: #include "core/layout/TracedLayoutObject.h"
...
#include "blinkit/blink/renderer/core/paint/FramePainter.h"
#include "blinkit/blink/renderer/core/paint/PaintLayer.h"
#include "blinkit/blink/renderer/core/paint/PaintPropertyTreeBuilder.h"
...
#endif
#include "blinkit/blink/renderer/platform/HostWindow.h"
...
#include "blinkit/blink/renderer/platform/geometry/DoubleRect.h"
...
#include "blinkit/blink/renderer/platform/scroll/ScrollAnimatorBase.h"
...
FrameView::FrameView(LocalFrame* frame)
    ...
    // BKTODO: , m_renderThrottlingObserverNotificationFactory(CancellableTaskFactory::create(this, &FrameView::notifyRenderThrottlingObservers))
    , m_isTransparent(false)
    , m_baseBackgroundColor(Color::white)
    // BKTODO: , m_mediaType(MediaTypeNames::screen)
...
void FrameView::setMediaType(const AtomicString& mediaType)
{
    ...
    m_frame->document()->mediaQueryAffectingValueChanged();
    ASSERT(false); // BKTODO: m_mediaType = mediaType;
}
...
void FrameView::scrollToAnchor()
{
    ...
    if (anchorNode->layoutObject()) {
        ...
        } else if (Settings::rootLayerScrolls()) {
...
{
    return Settings::ignoreMainFrameOverflowHiddenQuirk() && m_frame->isMainFrame();
}
...
void FrameView::collectFrameTimingRequests(GraphicsLayerFrameTimingRequests& graphicsLayerTimingRequests)
{
    ...
    graphicsLayerTimingRequests[graphicsLayer].emplace_back(std::make_pair(m_frame->frameID(), enclosingIntRect(viewRect)));
}
