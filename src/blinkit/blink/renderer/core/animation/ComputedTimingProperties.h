...
#ifndef BLINKIT_BLINKIT_COMPUTED_TIMING_PROPERTIES_H
#define BLINKIT_BLINKIT_COMPUTED_TIMING_PROPERTIES_H
...
#endif // BLINKIT_BLINKIT_COMPUTED_TIMING_PROPERTIES_H
