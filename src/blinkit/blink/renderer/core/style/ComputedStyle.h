...
public:
    ...
    bool hasFilter() const { return !rareNonInheritedData->m_filter->m_operations.operations().empty(); }
    ...
    bool hasBackdropFilter() const { return !rareNonInheritedData->m_backdropFilter->m_operations.operations().empty(); }
