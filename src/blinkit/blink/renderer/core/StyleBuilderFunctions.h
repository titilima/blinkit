...
public:
    ...
    static void applyValueCSSPropertyContain(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyTextCombineUpright(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyBackdropFilter(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyGridRowGap(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyFontFeatureSettings(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyTextOrientation(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyImageOrientation(StyleResolverState&, CSSValue*);
    ...
    static void applyValueCSSPropertyGridColumnGap(StyleResolverState&, CSSValue*);
