...
GCPassPtr<StyleRuleImport> StyleRuleImport::create(const String& href, PassRefPtrWillBeRawPtr<MediaQuerySet> media)
{
    return WrapLeaked(new StyleRuleImport(href, media));
}
