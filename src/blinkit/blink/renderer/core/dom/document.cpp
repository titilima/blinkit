...
#include "blinkit/blink/renderer/core/animation/DocumentAnimations.h"
...
#include "blinkit/blink/renderer/core/css/resolver/StyleResolverStats.h"
#if 0 // BKTODO:
...
#include "blinkit/blink/renderer/core/dom/DocumentVisibilityObserver.h" // BKTODO: Was in HTMLCanvasElement.h
#include "blinkit/blink/renderer/core/dom/element.h"
#include "blinkit/blink/renderer/core/dom/ElementDataCache.h"
#include "blinkit/blink/renderer/core/dom/ElementRegistrationOptions.h"
...
#include "blinkit/blink/renderer/core/dom/MainThreadTaskRunner.h"
...
#include "blinkit/blink/renderer/core/dom/NodeIterator.h"
#include "blinkit/blink/renderer/core/dom/NodeRareData.h"
#include "blinkit/blink/renderer/core/dom/NodeWithIndex.h"
...
#include "blinkit/blink/renderer/core/dom/ScriptedAnimationController.h"
#include "blinkit/blink/renderer/core/dom/ScriptedIdleTaskController.h"
...
// BKTODO: #include "core/dom/TransformSource.h"
#include "blinkit/blink/renderer/core/dom/TreeWalker.h"
// BKTODO: #include "core/dom/VisitedLinkState.h"
// BKTODO: #include "core/dom/XMLDocument.h"
#include "blinkit/blink/renderer/core/dom/custom/CustomElementMicrotaskRunQueue.h"
...
#include "blinkit/blink/renderer/core/events/BeforeUnloadEvent.h"
...
#include "blinkit/blink/renderer/core/html/HTMLAllCollection.h"
...
// BKTODO: #include "core/html/PluginDocument.h"
...
#include "blinkit/blink/renderer/core/html/imports/HTMLImportLoader.h"
...
#include "blinkit/blink/renderer/core/page/EventWithHitTestResults.h"
...
#include "blinkit/blink/renderer/core/page/PointerLockController.h"
...
// BKTODO: #include "platform/network/ContentSecurityPolicyParsers.h"
...
#include "blinkit/blink/renderer/platform/text/SegmentedString.h"
#if 0 // BKTODO:
#include "platform/weborigin/OriginAccessEntry.h"
#include "platform/weborigin/SchemeRegistry.h"
#include "platform/weborigin/SecurityOrigin.h"
#endif
// BKTODO: #include "public/platform/WebFrameScheduler.h"
#include "blinkit/blink/renderer/wtf/CurrentTime.h"
#include "blinkit/blink/renderer/wtf/DateMath.h"
#include "blinkit/blink/renderer/wtf/Functional.h"
#include "blinkit/blink/renderer/wtf/HashFunctions.h"
...
#include "blinkit/blink/renderer/wtf/text/TextEncodingRegistry.h"
...
Document::Document(const DocumentInit& initializer, DocumentClassFlags documentClasses)
    ...
    // BKTODO: , m_visitedLinkState(VisitedLinkState::create(*this))
...
{
    ASSERT(false); // BKTODO: return isHTMLHtmlElement(documentElement()) && documentElement()->hasAttribute(manifestAttr);
    return false;
}
...
GCRefPtr<DocumentFragment> Document::createDocumentFragment()
{
...
GCRefPtr<Node> Document::importNode(Node* importedNode, bool deep, ExceptionState& exceptionState)
{
    ...
    case DOCUMENT_FRAGMENT_NODE: {
        ...
        GCRefPtr<DocumentFragment> newFragment = createDocumentFragment();
...
{
    ASSERT(false); // BKTODO: m_xmlStandalone = standalone ? Standalone : NotStandalone;
}
...
void Document::setTitleElement(Element* titleElement)
{
    ...
    if (m_titleElement && m_titleElement.get() != titleElement) {
        if (isHTMLDocument() || isXHTMLDocument()) {
            ...
            ASSERT(false); // BKTODO: m_titleElement = Traversal<SVGTitleElement>::firstWithin(*this);
        }
    } else {
...
void Document::updateLayout()
{
    ...
    if (HTMLFrameOwnerElement* owner = ownerElement())
        ASSERT(false); // BKTODO: owner->document().updateLayout();
...
bool Document::isFrameSet() const
{
    if (!isHTMLDocument())
        return false;
    ASSERT(false); // BKTODO: return isHTMLFrameSetElement(body());
    return false;
}
...
void Document::open(Document* ownerDocument, ExceptionState& exceptionState)
{
    ...
    if (ownerDocument) {
        ...
        // BKTODO: setSecurityOrigin(ownerDocument->securityOrigin());
    }
...
void Document::setBody(PassRefPtrWillBeRawPtr<HTMLElement> prpNewBody, ExceptionState& exceptionState)
{
    ...
    if (!newBody) {
        ASSERT(false); // BKTODO: exceptionState.throwDOMException(HierarchyRequestError, ExceptionMessages::argumentNullOrIncorrectType(1, "HTMLElement"));
        return;
    }
    if (!documentElement()) {
...
bool Document::dispatchBeforeUnloadEvent(ChromeClient& chromeClient, bool isReload, bool& didAllowNavigation)
{
    ...
    if (didAllowNavigation) {
        ASSERT(false); // BKTODO: addConsoleMessage(ConsoleMessage::create(JSMessageSource, ErrorMessageLevel, "Blocked attempt to show multiple 'beforeunload' confirmation panels for a single navigation."));
        return true;
    }
...
void Document::write(const SegmentedString& text, Document* ownerDocument, ExceptionState& exceptionState)
{
    ...
    if (!hasInsertionPoint && m_ignoreDestructiveWriteCount) {
        ASSERT(false); // BKTODO: addConsoleMessage(ConsoleMessage::create(JSMessageSource, WarningMessageLevel, ExceptionMessages::failedToExecute("write", "Document", "It isn't possible to write into a document from an asynchronously-loaded external script unless it is explicitly opened.")));
        return;
    }
...
{
    ASSERT(false); // BKTODO: return &m_timers;
    return nullptr;
}
...
void Document::processBaseElement()
{
    ...
    if (href) {
        ...
        if (!strippedHref.isEmpty())
            ASSERT(false); // BKTODO: baseElementURL = KURL(url(), strippedHref);
    }
    ASSERT(false); // BKTODO:
#if 0
...
void Document::disableEval(const String& errorMessage)
{
    ...
    ASSERT(false); // BKTODO: frame()->script().disableEval(errorMessage);
}
...
bool Document::setFocusedElement(PassRefPtrWillBeRawPtr<Element> prpNewFocusedElement, const FocusParams& params)
{
    ...
    if (newFocusedElement && newFocusedElement->isFocusable()) {
        ...
        if (m_focusedElement->isRootEditableElement())
            ASSERT(false); // BKTODO: frame()->spellChecker().didBeginEditing(m_focusedElement.get());
...
bool Document::execCommand(const String& commandName, bool, const String& value, ExceptionState& exceptionState)
{
    ...
    if (m_isRunningExecCommand) {
        ...
        ASSERT(false); // BKTODO: addConsoleMessage(ConsoleMessage::create(JSMessageSource, WarningMessageLevel, message));
        return false;
    }
...
void Document::updateHoverActiveState(const HitTestRequest& request, Element* innerElement)
{
    ...
    while (innerElementInDocument && innerElementInDocument->document() != this) {
        ...
        ASSERT(false); // BKTODO: innerElementInDocument = innerElementInDocument->document().ownerElement();
    }
...
Locale& Document::getCachedLocale(const AtomicString& locale)
{
    ...
    std::unique_ptr<Locale> &ret = m_localeCache[localeKey];
    if (!ret)
        ret = Locale::create(localeKey);
    return *ret;
}
