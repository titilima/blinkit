...
#include "blinkit/blink/renderer/core/XMLNames.h"
...
#include "blinkit/blink/renderer/core/dom/ElementTraversal.h"
#include "blinkit/blink/renderer/core/dom/ExceptionCode.h"
#include "blinkit/blink/renderer/core/dom/FirstLetterPseudoElement.h"
...
#include "blinkit/blink/renderer/core/dom/PresentationAttributeStyle.h"
...
#include "blinkit/blink/renderer/core/dom/shadow/ShadowRootInit.h"
...
#if 0 // BKTODO:
#include "blinkit/blink/renderer/core/html/HTMLFrameElementBase.h"
#include "blinkit/blink/renderer/core/html/HTMLFrameOwnerElement.h"
#endif
...
#include "blinkit/blink/renderer/core/page/scrolling/ScrollCustomizationCallbacks.h"
#include "blinkit/blink/renderer/core/page/scrolling/ScrollState.h"
#include "blinkit/blink/renderer/core/page/scrolling/ScrollStateCallback.h"
...
#include "blinkit/blink/renderer/wtf/BitVector.h"
...
ElementAnimations& Element::ensureElementAnimations()
{
    ...
    if (!rareData.elementAnimations())
        rareData.setElementAnimations(std::make_unique<ElementAnimations>());
...
MutableStylePropertySet& Element::ensureMutableInlineStyle()
{
    ...
    return *toMutableStylePropertySet(inlineStyle.get());
}
