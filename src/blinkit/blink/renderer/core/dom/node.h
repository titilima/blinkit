...
#include "blinkit/blink/renderer/platform/weborigin/KURLHash.h"
...
public:
    ...
    GCRefPtr<Node> removeChild(PassRefPtrWillBeRawPtr<Node> child, ExceptionState& = ASSERT_NO_EXCEPTION);
