...
StringImpl* lookupHTMLTag(const UChar* data, unsigned length)
{
    ...
    case 5:
        switch (data[0]) {
        case 'a':
            if (data[1] == 's' && data[2] == 'i' && data[3] == 'd' && data[4] == 'e')
    ...
    case 6:
        ...
        case 'b':
            ...
            return 0;
        case 'c':
            if (data[1] == 'e' && data[2] == 'n' && data[3] == 't' && data[4] == 'e' && data[5] == 'r')
        ...
        case 'l':
            ...
            return 0;
        case 'o':
            if (data[1] == 'p' && data[2] == 't' && data[3] == 'i' && data[4] == 'o' && data[5] == 'n')
    ...
    case 8:
        ...
        case 'd':
            ...
            return 0;
        case 'f':
            if (data[1] == 'i' && data[2] == 'e' && data[3] == 'l' && data[4] == 'd' && data[5] == 's' && data[6] == 'e' && data[7] == 't')
