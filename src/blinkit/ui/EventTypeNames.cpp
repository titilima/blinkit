...
const AtomicString& input = reinterpret_cast<AtomicString*>(&NamesStorage)[30];
const AtomicString& invalid = reinterpret_cast<AtomicString*>(&NamesStorage)[31];
const AtomicString& keydown = reinterpret_cast<AtomicString*>(&NamesStorage)[32];
const AtomicString& keypress = reinterpret_cast<AtomicString*>(&NamesStorage)[33];
const AtomicString& keyup = reinterpret_cast<AtomicString*>(&NamesStorage)[34];
const AtomicString& load = reinterpret_cast<AtomicString*>(&NamesStorage)[35];
const AtomicString& loading = reinterpret_cast<AtomicString*>(&NamesStorage)[36];
const AtomicString& loadingdone = reinterpret_cast<AtomicString*>(&NamesStorage)[37];
const AtomicString& loadingerror = reinterpret_cast<AtomicString*>(&NamesStorage)[38];
const AtomicString& mousedown = reinterpret_cast<AtomicString*>(&NamesStorage)[39];
const AtomicString& mouseenter = reinterpret_cast<AtomicString*>(&NamesStorage)[40];
const AtomicString& mouseleave = reinterpret_cast<AtomicString*>(&NamesStorage)[41];
const AtomicString& mousemove = reinterpret_cast<AtomicString*>(&NamesStorage)[42];
const AtomicString& mouseout = reinterpret_cast<AtomicString*>(&NamesStorage)[43];
const AtomicString& mouseover = reinterpret_cast<AtomicString*>(&NamesStorage)[44];
const AtomicString& mouseup = reinterpret_cast<AtomicString*>(&NamesStorage)[45];
const AtomicString& mousewheel = reinterpret_cast<AtomicString*>(&NamesStorage)[46];
const AtomicString& pagehide = reinterpret_cast<AtomicString*>(&NamesStorage)[47];
const AtomicString& pageshow = reinterpret_cast<AtomicString*>(&NamesStorage)[48];
const AtomicString& paste = reinterpret_cast<AtomicString*>(&NamesStorage)[49];
const AtomicString& readystatechange = reinterpret_cast<AtomicString*>(&NamesStorage)[50];
const AtomicString& reset = reinterpret_cast<AtomicString*>(&NamesStorage)[51];
const AtomicString& resize = reinterpret_cast<AtomicString*>(&NamesStorage)[52];
const AtomicString& scroll = reinterpret_cast<AtomicString*>(&NamesStorage)[53];
const AtomicString& search = reinterpret_cast<AtomicString*>(&NamesStorage)[54];
const AtomicString& select = reinterpret_cast<AtomicString*>(&NamesStorage)[55];
const AtomicString& selectionchange = reinterpret_cast<AtomicString*>(&NamesStorage)[56];
const AtomicString& selectstart = reinterpret_cast<AtomicString*>(&NamesStorage)[57];
const AtomicString& submit = reinterpret_cast<AtomicString*>(&NamesStorage)[58];
const AtomicString& textInput = reinterpret_cast<AtomicString*>(&NamesStorage)[59];
const AtomicString& toggle = reinterpret_cast<AtomicString*>(&NamesStorage)[60];
const AtomicString& transitionend = reinterpret_cast<AtomicString*>(&NamesStorage)[61];
const AtomicString& unload = reinterpret_cast<AtomicString*>(&NamesStorage)[62];
const AtomicString& visibilitychange = reinterpret_cast<AtomicString*>(&NamesStorage)[63];
const AtomicString& webkitBeforeTextInserted = reinterpret_cast<AtomicString*>(&NamesStorage)[64];
const AtomicString& webkitEditableContentChanged = reinterpret_cast<AtomicString*>(&NamesStorage)[65];
const AtomicString& webkitvisibilitychange = reinterpret_cast<AtomicString*>(&NamesStorage)[66];
const AtomicString& wheel = reinterpret_cast<AtomicString*>(&NamesStorage)[67];
