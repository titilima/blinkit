...
cd $(dirname $0)
php event_type_names.h.php > ../src/chromium/third_party/blink/renderer/core/event_type_names.h
php event_type_names.cpp.php > ../src/chromium/third_party/blink/renderer/core/event_type_names.cpp
